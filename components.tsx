...
const DuplicateWarning = ({ onFix }: { onFix: () => void; }) => (
    <div className="duplicate-warning">
        <p>Some views may be duplicates. If they are, you can try to correct them.</p>
        <button onClick={onFix}>Fix Views</button>
    </div>
);
...
export const ResultsDisplay = ({
    ...
    onDownloadFullViewSquare,
    onDownloadFullViewIndividuals,
    onDownloadStylePack,
    // Full View
    fullViewResult,
    ...
    onDownloadFullViewSquare: () => void;
    onDownloadFullViewIndividuals: () => void;
    ...
    <div className="results-panel">
      ...
      <div className="tab-content">
        ...
        {activeTab === 'full-view' && (
            ...
            fullViewResult?.grid ? (
                <>
                    {duplicateWarning && <DuplicateWarning onFix={onFixDuplicates} />}
                    <div className="result-image-wrapper"><img src={fullViewResult.grid} alt="Full view grid" className="result-image" /></div>
                    <div className="result-actions">
                         <button className="download-button" onClick={onDownloadFullViewSquare} disabled={!fullViewResult.grid}>Download Square</button>
                         <button className="download-button" onClick={onDownloadFullViewIndividuals}>Download Individuals</button>
                    </div>
                </>
            ) : (
